    				...
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <tbody>
                                ...
                                <tr class="text-center">
                                    <td class="product-remove"><a href="/remove-item/{{$product['product_id']}}"><span class="ion-ios-close"></span></a></td>
                                    ...
                                    <form action="/update-quntity/{{$product['product_id']}}" method="post">
                                        {{csrf_field()}}
                                        <td class="quantity">
