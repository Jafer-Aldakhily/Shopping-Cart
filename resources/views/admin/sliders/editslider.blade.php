        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- form start -->
              <!-- <form id="quickForm"> -->
                {!! Form::open(['action' => 'App\Http\Controllers\SliderController@updateSlider','autocomplete' => 'off','enctype' => 'multipart/form-data']) !!}
                  {{csrf_field()}}
                  {{Form::hidden('id' , $slider->id)}}
                <div class="card-body">
                  <div class="form-group">
                    {{Form::label('' , 'Description1' , ['for' => 'exampleInputEmail1'])}}
                    {{Form::text('description1' , $slider->description1 , ['class' => 'form-control' , 'id' => 'exampleInputEmail1' ,'placeholder' => 'Enter Enter description1'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('' , 'Description2')}}
                    {{Form::text('description2' , $slider->description2 , ['class' => 'form-control' , 'placeholder' => 'Enter description2'])}}
                  </div>
