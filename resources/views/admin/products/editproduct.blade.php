        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <!-- form start -->
              <!-- <form id="quickForm"> -->
                {!! Form::open(['action' => ['App\Http\Controllers\ProductController@updateProduct' , $product->id],'autocomplete' => 'off','enctype' => 'multipart/form-data']) !!}
                  {{csrf_field()}}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('product_price' , $product->product_price , ['class' => 'form-control' , 'placeholder' => 'Enter price name'])}}
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      ...
                      {{Form::hidden('privouse_image' , $product->product_image)}}
