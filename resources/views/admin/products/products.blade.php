              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($products as $product)
                    ...
                    <td>
                        @if ($product->status == 1)
                        <a href="/unactiveproduct/{{$product->id}}" class="btn btn-warning">Unactivate</a>
                        @else
                        <a href="/activeproduct/{{$product->id}}" class="btn btn-success">activate</a>
                        @endif
                      <a href="/editproduct/{{$product->id}}" class="btn btn-primary"><i class="nav-icon fas fa-edit"></i></a>
